...
function scene:createScene( event )
	...
	--local line1 = display.newRect( group, (star1.x+star2.x)/2, (star1.y+star2.y)/2, 100, 3 )
	--local line1 = display.newImageRect( group, "images/line.png", 120, 3 )
	--line1.x = (star1.x+star2.x)/2
	--line1.y = (star1.y+star2.y)/2
	--line1.rotation = 5
	line1:setStrokeColor( R,G,B )
	line1.strokeWidth = 3
	physics.addBody (line1, "static", {friction=0})
	
	local line2 = display.newLine( group, star4.x, star4.y, star2.x, star2.y, star5.x, star5.y )
