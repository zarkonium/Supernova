...
function scene:createScene( event )
	...
	local star0 = display.newImageRect( group, "images/circle.png", 2*radius, 2*radius )
	star0.x = 200
	star0.y = 92
	star0:setFillColor(R,G,B)
	physics.addBody (star0, "static", {friction=0, radius=radius})
	...
	local line1 = display.newLine( group, star0.x, star0.y, star1.x, star1.y, star2.x, star2.y, star3.x, star3.y, star4.x, star4.y, star5.x, star5.y, star6.x, star6.y, star3.x, star3.y )
