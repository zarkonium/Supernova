...
function scene:createScene( event )
	...
	local numCircles = 13
	local numBigCircles = 2
	local score = 0
	local targetScore = 13
	...
	local star7 = display.newImageRect( group, "images/circle.png", 2*radius, 2*radius )
	star7.x = 79
	star7.y = 418
	star7:setFillColor(R,G,B)
	physics.addBody (star7, "static", {friction=0, radius=radius})
	
	local star8 = display.newImageRect( group, "images/circle.png", 2*radius, 2*radius )
	star8.x = 280
	star8.y = 502
	star8:setFillColor(R,G,B)
	physics.addBody (star8, "static", {friction=0, radius=radius})
	
	local line1 = display.newLine( group, star1.x, star1.y, star2.x, star2.y)
	line1:setStrokeColor( R,G,B )
	line1.strokeWidth = 3
	physics.addBody (line1, "static", {friction=0})
	
	local line2 = display.newLine( group, star1.x, star1.y, star4.x, star4.y, star6.x, star6.y, star5.x, star5.y, star1.x, star1.y )
	line2:setStrokeColor( R,G,B )
	line2.strokeWidth = 3
	physics.addBody (line2, "static", {friction=0})
	
	local line3 = display.newLine( group, star3.x, star3.y, star4.x, star4.y)
	line3:setStrokeColor( R,G,B )
	line3.strokeWidth = 3
	physics.addBody (line3, "static", {friction=0})
	
	local line4 = display.newLine( group, star5.x, star5.y, star7.x, star7.y)
	line4:setStrokeColor( R,G,B )
	line4.strokeWidth = 3
	physics.addBody (line4, "static", {friction=0})
	
	local line5 = display.newLine( group, star6.x, star6.y, star8.x, star8.y)
	line5:setStrokeColor( R,G,B )
	line5.strokeWidth = 3
	physics.addBody (line5, "static", {friction=0})
